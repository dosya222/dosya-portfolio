...
const socialLinks = [
    {
      href: 'https://github.com/dosya222',
    ...
    {
      href: 'https://www.linkedin.com/in/doston-okeen-999679336/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/ab1lvvv',
...
<div className="flex items-center gap-2 mt-auto">
    {socialLinks.map(({ href, icon }, key) => (
        ...
        href={href}
        target="_blank"
        className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[bakcground-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/50 reveal-up"
        >
{icon}
        </a>
    ))}
...
<form 
action="https://getform.io/f/adrrrzxa" 
method="POST"
...
autoComplete="email"
required
placeholder="dostonnet010@gmail.com"
className="text-field reveal-up"
